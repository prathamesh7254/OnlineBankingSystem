...
class Transaction {
    ...
    // Setters (optional, if you need to modify these values after object creation)
...
public class OnlineBankingSystem {
    ...
    private static void transferFunds(User user) {
        ...
        if (sourceAccount != null && destinationAccount != null) {
            ...
            double amount = scanner.nextDouble();
            sourceAccount.addTransaction("Transfer - Sent", amount);
            destinationAccount.addTransaction("Transfer - Received", amount);
    ...
    private static void viewTransactionHistory(User user) {
        ...
        for (Map.Entry<String, Account> entry : user.getAccounts().entrySet()) {
            ...
            System.out.println("Account Type: " + entry.getKey());
